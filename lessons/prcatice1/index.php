...
<body>
<?php extract(include 'data/main.php'); ?>
    <div class="wrapper">
        <div class="sidebar-wrapper">
            ...
            <div class="education-container container-block">
                ...
                <div class="item">
                    ...
                    <div class="time"><?=$value['time-from'] . $value['time-to'] ? $value['time-to'] : '...'?></div>
                </div><!--//item-->
                <?php } ?>
            ...
            <div class="languages-container container-block">
                ...
                <ul class="list-unstyled interests-list">
                    <?php foreach ($language as $lname => $level){ ?>
                    <li><?=$lname?> <span class="lang-desc">(<?=$level?>)</span></li>
                    <?php } ?>
                </ul>
            </div><!--//interests-->
